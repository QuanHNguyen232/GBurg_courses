...
public class MancalaTournament {
	...
	private static final int NUM_GAMES = 5; // TODO - set the number of games per match
	...
	public static void main(String[] args) throws Exception {
		...
		String[] playerIdentifiers = {"QuDo2", "Simple"};
	...
	private static int[] runGames(String player1, String player2, PrintWriter p) {
		try {
			...
			for (int g = 0; g < NUM_GAMES; g++) { // best of NUM_GAMES
				...
				MancalaNode node = new ScoreDiffMancalaNode(0);
				p.println(node);
