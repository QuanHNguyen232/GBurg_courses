...
public class Card {	// Alt + Shift + J for Javadoc comment
	 ...
	 * The Card toString gets its characters from the RANK_CHARS and SUIT_CHARS static fields at the indices
	 * of fields <code>rank</code> and <code>suits</code>, respectively
	 */
	@Override
